...
alias qdel2='$play/utils/qdel.sh'
...
alias sub='bash $play/vasp/sub.sh'
...
alias vitar='vi $play/alias-tars.sh'
...
alias getrst='python $play/vasp/get_restart.py'
...
alias fo='python $happy/find_o_type.py'
...
alias showimg='python $happy/visualize_atoms.py'
...
alias cpbarrier='cp $happy/getbarrier.py .'
...
alias udinput='bash $play/vasp/update_inputs.sh'
...
alias plottemp='python $bin/CES2-automation/tools/plot_temperature.py'
alias orient='python $bin/CES2-automation/tools/water_orientation.py'
